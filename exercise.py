...
train_labels, train_texts = get_labels_and_texts('data/train.bz2')
...
ffnn.add(layers.Embedding(vocabSize, 200, input_length=MAX_LENGTH))
...
ffnn.fit(train_texts, train_labels, epochs=10, batch_size=10)

## okok if we put more into it, it should get really good
